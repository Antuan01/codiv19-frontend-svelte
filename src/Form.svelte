    ...
    <form class="px-8 pt-6 pb-8 mb-4">
        <div class="mb-6">
            ...
            {#if errors.includes('name')}
                <p class="text-red-500">The name is required</p>
            {/if}
        </div>
        <div class="mb-6">
        ...
        <div class="mb-6">
            <label class="block text-sm font-bold mb-2" for="number"> Number </label>
            <input
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3
                    leading-tight focus:outline-none focus:shadow-outline"
                id="number"
            ...
            {#if errors.includes('number')}
                <p class="text-red-500">The number field is requiered</p>
            {/if}
        </div>
